...
<head>
  ...
  {{--dataTabels--}}
  {{--<link href="/plugin/datatables/jquery.dataTables.min.css" rel="stylesheet">--}}
  ...
  <link href="/dist/css/load/load.css" rel="stylesheet">
    ...
    <!-- SlimScroll -->
    <script src="/plugin/slimScroll/jquery.slimscroll.min.js" type="text/javascript') }}"></script>
    <!-- FastClick -->
    <script src="/plugin/fastclick/fastclick.min.js" type="text/javascript"></script>
    <!-- AdminLTE App -->
    <!-- AdminLTE for demo purposes -->
    <!-- Select2 -->
    <script src="/plugin/select2/select2.full.min.js" type="text/javascript"></script>
    <!-- InputMask -->
    <script src="/plugin/input-mask/jquery.inputmask.js" type="text/javascript"></script>
    <script src="/plugin/input-mask/jquery.inputmask.date.extensions.js" type="text/javascript"></script>
    <script src="/plugin/input-mask/jquery.inputmask.extensions.js" type="text/javascript"></script>
